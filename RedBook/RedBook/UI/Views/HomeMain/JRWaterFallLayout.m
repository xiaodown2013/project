...
static const CGFloat JRDefaultRowMargin = 8; // 行间距
static const CGFloat JRDefaultColumnMargin = 8; // 列间距
static const UIEdgeInsets JRDefaultEdgeInsets = {8, 8, 8, 8}; // edgeInsets
